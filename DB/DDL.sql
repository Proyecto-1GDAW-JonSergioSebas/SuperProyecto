...
/
CREATE OR REPLACE SYNONYM PL_MU_TA
FOR PLAYER_MUTATING_TABLE;
/
CREATE OR REPLACE SYNONYM AD_MU_TA
FOR ADMIN_MUTATING_TABLE;
/
CREATE OR REPLACE SYNONYM UN_US_AD
FOR UNIQUE_USERNAME_ADMIN;
/
CREATE OR REPLACE SYNONYM US_MU_TA
FOR USER_MUTATING_TABLE;
/
CREATE OR REPLACE SYNONYM UN_US_US
FOR UNIQUE_USERNAME_DBUSER;
/
CREATE OR REPLACE SYNONYM OW_MU_TA
FOR OWNER_MUTATING_TABLE;
/
CREATE OR REPLACE SYNONYM UN_US_OW
FOR UNIQUE_USERNAME_OWNER;
/
CREATE OR REPLACE SYNONYM CL_TP
FOR CLASSIFICATION_TEMP;