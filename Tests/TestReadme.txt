...
en este caso el tipo de cuenta es Admin asi que tendra que devolver 3
si,por ejemplo, el resultado esperado fuera Owner, el resultado seria 2
, si fuera User, el resultado seria 1
y si la cuenta no existiera el resultado seria 0.
...
en expresult se colocara 0,1,2 o 3 dependiendo de lo que se espere.
...
con otros equipos el resultado seria diferente,
para los equipos que ya existen seria:
Aon     1;
Rua     2;
Kolme   3;
Papat   4;
...
en expresult se colocara el ID del equipo que corresponda con ese nombre
